...
<head>
	<title>Set Seminar Propsal | Sistem Manajemen Tugas Akhir</title>
	<meta charset="utf-8">
				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							<h3 class="panel-title">Pengaturan Seminar Propsal</h3>

						</div>
						<div class="panel">
								<form action="/setsemprop" method="POST">
									@csrf
								<div class="panel-body">
									...
									<br>
									<h4>Pembimbing</h4>
									<input type="text" class="form-control" placeholder="usulan Pembimbing 1" required="" name="pembimbing1" value="{{$data->pembimbing1}}">
									<br>
									<input type="text" required="" class="form-control" name="pembimbing2" placeholder="usulan Pembimbing 2" value="{{$data->pembimbing2}}">
									<br>
									<h4>Penguji</h4>
									...
									<input type="text" required="" class="form-control" name="tempat" placeholder="Tempat Ujian">
									<br>
									<input type="date" required="" class="form-control" name="tanggal" placeholder="usulan Ketua Sidang">
									<br>
									<input type="time" required="" class="form-control" name="jam" placeholder="usulan Ketua Sidang">
									<br>
