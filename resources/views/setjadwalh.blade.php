...
<head>
	<title>Siapkan Ujian Hasil | Klorofil - Free Bootstrap Dashboard Template</title>
	<meta charset="utf-8">
				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							...
							<p class="panel-subtitle">Seminar Hasil</p>
						</div>
						<div class="panel">
								<form action="/setsemhas" method="POST">
									@csrf
								<div class="panel-body">
									...
									<input type="text" class="form-control" required="" name="tempat" placeholder="Tempat Seminar">
									<br>
									<input type="date" class="form-control" name="tanggal" placeholder="usulan Ketua Sidang">
									<br>
									<input type="time" class="form-control" name="jam" placeholder="usulan Ketua Sidang">
									<br>
