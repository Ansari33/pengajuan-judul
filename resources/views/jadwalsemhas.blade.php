...
<head>
	<title>Jadwal Seminar Propsal | Sistem Manajemen Tugas Akhir Mahasiswa</title>
	<meta charset="utf-8">
		...
		<nav class="navbar navbar-default navbar-fixed-top">
			...
			<div class="container-fluid">
				...
				<div class="navbar-btn navbar-btn-right">
					<a class="btn btn-success update-pro" href="/login" title="Login Admin"><i class="fa fa-lock"></i> <span>Login</span></a>
				</div>
				<div id="navbar-menu">
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li>
							<a href="#subPages" data-toggle="collapse" class="collapsed"><i class="lnr lnr-file-empty"></i> <span>Proposal</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
							<div id="subPages" class="collapse ">
								<ul class="nav">
									<li><a href="/ajukanprop" class="">Pengajuan Proposal</a></li>
									<li><a href="/diterima" class="">Propsal Diterima</a></li>
									<li><a href="/ditolak" class="">Propsal Ditolak</a></li>
								</ul>
							</div>
						</li>
						<li>
						...
						<div class="col-md-12">
							...
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title"><a href="">Propsal Diterima</a></h3>
									<div class="right">
									...
									<table class="table table-striped">
										...
										<tbody>
											...
											<tr>
												...
												<td>{{$d->status}}</td>
												<td>{{$d->jadwal}}</td>
												<td><a href="/detail/{{$d->id}}"><i class="fa fa-book"></i></a></td>
