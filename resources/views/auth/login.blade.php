...
<head>
    <title>Login Admin | Sistem Manajemen Tugas Akhir Mahasiswa</title>
    <meta charset="utf-8">
                ...
                <div class="container-fluid" style="margin:30%; margin-top:60px; margin-bottom: 30px;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="panel">
                                <div class="panel-heading">
                                    <h3><strong>LOGIN ADMIN</strong> <i class="fa fa-lock  "></i></h3>
                                </div>
                                
                                <div class="panel-body text-center">
                                    <form class="form-group" style="" method="POST" action="/masuk">
                                        @csrf
