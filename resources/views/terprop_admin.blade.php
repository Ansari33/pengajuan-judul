						...
						<li>
							...
							<div id="subPages2" class="collapse ">
								<ul class="nav">
									...
									<li><a href="/terujip" class="active">Telah Seminar Proposal</a></li>
						...
						<div class="col-md-12">
							...
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title"><a href="">Seminar Proposal yang telah Diujikan</a></h3>
									<div class="right">
										<a href="/print_p" class="btn btn-info btn-sm"><i class="
