...
<head>
	<title>Daftar Pengajuan Judul | Admin</title>
	<meta charset="utf-8">
			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li >
							<a href="#subPages" data-toggle="collapse" class="collapsed"><i class="lnr lnr-file-empty active"></i> <span>Judul TA</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
							<div id="subPages" class="collapse ">
								<ul class="nav">
									<li><a href="/ajuanjudul_admin" class="active">Daftar Ajuan Judul TA</a></li>
						...
						<div class="col-md-12">
							...
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title"><a href="">Daftar Data Dosen</a></h3>
									<div class="right">

										<a href="/adosen"  class="btn btn-primary"><i class=""></i> Input Dosen Baru</a>
									...
									<table class="table table-responsive">
										...
										<tbody>
											...
											<tr>
												...
												<td>
													<a href="/d_dosen/{{$d->id}}" class="btn btn-xs btn-danger" title="Hapus"><i class="fa fa-trash"></i></a>
													<a href="/v_dosen/{{$d->id}}" class="btn btn-xs btn-warning" title="Edit Dosen"><i class="fa fa-eye"></i></a>
												</td>
											</tr>
											@endforeach
										</tbody>
