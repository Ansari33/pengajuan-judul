...
<head>
	<title>Daftar Pengajuan Seminar Tutup Admin | Klorofil - Free Bootstrap Dashboard Template</title>
	<meta charset="utf-8">
						...
						<li>
						 ...
						 <li>
                            ...
                            <div id="subPages4" class="collapse ">
                                <ul class="nav">
                                    <li><a href="/ajuansemtup_admin" class="active">Daftar Ajuan Seminar Skripsi</a></li>
						...
						<div class="col-md-12">
							...
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title"><a href=""></a>Daftar Pengajuan Seminar Skripsi</h3>
									<div class="right">
										...
										<tbody>
											...
											<tr>
												...
												<td>
													...
													<a href="/sett/{{$d->id}}" class="btn btn-xs btn-warning"><i class="fa fa-eye"></i></a>
												</td>
											</tr>
											@endforeach
										</tbody>
