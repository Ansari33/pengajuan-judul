				...
				<div class="container-fluid" style="margin:20%; margin-top:60px; margin-bottom: 30px;">
					...
					<div class="row">
						...
						<div class="col-lg-12">
							...
							<div class="panel">
								<div class="panel-heading">
									<h3><strong>Input Data Dosen</strong> <i class="fa fa-users  "></i></h3>
								</div>
								
								<div class="panel-body text-center">
									<form class="form-group" style="" method="POST" action="/addosen">
										@csrf
									<input class="form-control" placeholder="nip" type="text" name="nip">
									<br>
									<input name="nama" class="form-control" placeholder="Nama Lengkap & Gelar" type="text">
									<br>
									<input name="pangkat" class="form-control" placeholder="Pangkat Dosen" type="text">
									<br>
									<input name="golongan" class="form-control" placeholder="Golongan Dosen" type="text">
									<br>
									<input name="ruangan" class="form-control" placeholder="Ruanan Dosen" type="text">
									<br>
									<select class="form-control" required="" name="peminatan">
										<option>Pilih Spesialis Dosen</option>
										<option value="Jaringan">Jaringan</option>
										<option value="Rekayasa Perangkat Lunak">Rekayasa Perangkat Lunak</option>
									</select>
									<br>
									<button type="submit" class="btn btn-primary"><i class=""></i>Tambahkan</button>
									</form>
								</div>
