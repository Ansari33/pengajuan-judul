...
<head>
	<title>Daftar Pengajuan Seminar Hasil | Admin</title>
	<meta charset="utf-8">
					...
					<ul class="nav">
						...
						<li>
							...
							<div id="subPages3" class="collapse ">
								<ul class="nav">
									<li><a href="/ajuansemhas_admin" class="active">Daftar Ajuan Seminar Hasil</a></li>
						...
						<div class="col-md-12">
							...
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title"><a href=""></a>Daftar Pengajuan Seminar Hasil</h3>
									<div class="right">
										...
										<tbody>
											...
											<tr>
												...
												<td>
													...
													<a href="/seth/{{$d->id}}" class="btn btn-xs btn-warning"><i class="fa fa-eye"></i></a>
												</td>
											</tr>
											@endforeach
										</tbody>
