...
<head>
	<title>Ajukan Seminar Hasil | Klorofil - Free Bootstrap Dashboard Template</title>
	<meta charset="utf-8">
				...
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							...
							<p class="panel-subtitle">Seminar Propsal</p>
						</div>
						<div class="panel">
								<form action="/addsemhas" method="POST">
									@csrf
								<div class="panel-body">

									<input type="text" class="form-control" placeholder="stambuk" name="stambuk" required="">
									<br>

									<input type="text" class="form-control" name="nama" placeholder="nama" required="">
									<br>
									<textarea class="form-control" name="judul" placeholder="Judul Proposal" rows="4" required=""></textarea>
									<br>
									<input type="text" class="form-control" placeholder="usulan Pembimbing 1" name="pembimbing1">
									<br>
									<input type="text" class="form-control" name="pembimbing2" placeholder="usulan Pembimbing 2">
									<br>
									<input type="text" class="form-control" placeholder="Penguji Saat Seminar Proposal" name="penguji1">
									<br>
									<input type="text" class="form-control" name="penguji2" placeholder="Penguji Saat Seminar Proposal">
									<br>
									<input type="text" class="form-control" name="penguji3" placeholder="Penguji Saat Seminar Proposal">
									<br>
									<button type="submit" class="btn btn-success">Ajukan Seminar Hasil</button>
								</div>
								</form>
							</div>
					</div>
