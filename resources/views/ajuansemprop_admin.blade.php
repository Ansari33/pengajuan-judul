...
<head>
	<title>Daftar Pengajuan Seminar Proposal | Admin</title>
	<meta charset="utf-8">
						...
						<div class="col-md-12">
							...
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title"><a href=""></a>Pengajuan Seminar Proposal</h3>
									<div class="right">
									...
									<table class="table table-responsive">
										...
										<tbody>
											...
											<tr>
												...
												<td>{{$d->status}}</td>
												<td>
													<a href="/setp/{{$d->id}}" class="btn btn-xs btn-warning"><i class="fa fa-eye"></i></a>
												</td>
											</tr>
											@endforeach
										</tbody>
