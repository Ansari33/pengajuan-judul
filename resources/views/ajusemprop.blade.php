...
<head>
	<title>Ajukan Seminar Propsal | Klorofil - Free Bootstrap Dashboard Template</title>
	<meta charset="utf-8">
			...
			<div class="main-content">
				<div class="container-fluid">
					...
					<div class="panel panel-headline">
						...
						<div class="panel">
								<form action="/addsemprop" method="POST">
									@csrf
								<div class="panel-body">
									...
									<br>
									<button type="submit" class="btn btn-success">Ajukan Seminar Proposal</button>
								</div>
								</form>
							</div>
					</div>
