...
<head>
	<title>Jadwal Seminar Skripsi | Sistem Manajemen Tugas Akhir Mahasiswa</title>
	<meta charset="utf-8">
						...
						<li>
							...
							<div id="subPages4" class="collapse ">
								<ul class="nav">
									...
									<li><a href="/terujih" class="">Telah Seminar Skripsi</a></li>
						...
						<div class="col-md-12">
							...
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title"><a href="">Jadwal Seminar Skripsi</a></h3>
									<div class="right">
									...
									<table class="table table-striped">
										...
										<tbody>
											...
											<tr>
												...
												<td>{{$d->status}}</td>
												<td>{{$d->jadwalm}}</td>
												<td><a href="/ujikanm/{{$d->id}}" class=" btn btn-success btn-sm"><i class="fa fa-check"></i></a></td>
