...
<head>
	<title>Daftar Judul Yang Ditolak | Admin</title>
	<meta charset="utf-8">
						...
						<li>
							...
							<div id="subPages" class="collapse ">
								<ul class="nav">
									...
									<li><a href="/ditolak" class="active">Judul TA Ditolak</a></li>
								</ul>
							</div>
						</li>
						<li>
						...
						<div class="col-md-12">
							...
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title"><a href="">Daftar Judul Yang Ditolak</a></h3>
									<div class="right">
