...
<head>
	<title>Set Pembimbing Judul | Admin</title>
	<meta charset="utf-8">
		...
		<div class="main">
			...
			<div class="main-content">
				<div class="container-fluid" >
					<!-- OVERVIEW -->
							<p class="" style="text-align: center; margin-bottom: 0px; font-size: 24px; font-weight: bold;">Detail Pengajuan Tugas Akhir</p>
					<div class="panel panel-headline " style="margin: 1%;">
						<div class="panel-heading">
							 
						</div>
						<div class="panel" >
								<form action="/terimajudul" method="POST">
									@csrf
								<div class="panel-body">
									<input type="hidden" class="form-control" name="id"value="{{$data->id}}">
									<h4 style="margin-left: 60px;"><strong>Data Mahasiswa</strong></h4><br>
									<div class="row">
										
										<div class="col-md-6">
											<label>Stambuk</label>
											<input type="text" class="form-control" placeholder="stambuk" name="stambuk" required="" value="{{$data->stambuk}}" readonly="">
									<br>
										</div>
										<div class="col-md-6">
											<label>Nama</label>
											<input type="text" class="form-control" name="nama" placeholder="nama" required="" value="{{$data->nama}}" readonly="">
									<br>		
										</div>
									</div>
										...
										<h4 style="margin-left: 60px;"><strong>Daftar Usulan Judul</strong></h4><br>
									<div class="row">
										<div class="col-md-4">
											<label>Usulan Judul #1</label>
											<label class="fancy-radio">
										<input name="judul" value="{{$data->judul1}}" type="radio" required="">
										<span><i></i>{{$data->judul1}}</span>
									</label>	
										</div>

										<div class="col-md-4">
											<label>Usulan Judul #2</label>
										<label class="fancy-radio">
										<input name="judul" value="{{$data->judul2}}" type="radio" required="">
										<span><i></i>{{$data->judul2}}</span>
									</label>		
										</div>

										<div class="col-md-4">
											<label>Usulan Judul #3</label>
										<label class="fancy-radio">
										<input name="judul" value="{{$data->judul3}}" type="radio" required="">
										<span><i></i>{{$data->judul3}}</span>
									</label>		
										</div>
									</div>
									
									<br>
									<h4 style="margin-left: 60px;"><strong>Daftar Usulan Pembimbing / Tentukan Pembimbing</strong></h4>
									<br>
									<div class="row">
										<div class="col-md-4">
											<label>Usulan Pembimbing 1</label>
										<input type="text" class="form-control" placeholder="usulan Pembimbing 1"  value="{{$data->pembimbing1}}">
									<br>		
										</div>
										<div class="col-md-4">
											<label>Pilihan Pembimbing 1</label>
									...
									<br>		
										...
										<div class="col-md-4">
											<label>Nomor SK Pembimbing 1</label>
											<input type="text" class="form-control" name="skpb1" placeholder="Nomor SK pembimbing 1">
										</div>
									</div>
									<div class="row">
										<div class="col-md-4">
										<label>Usulan Pembimbing 2</label>
										<input type="text" class="form-control"  value="{{$data->pembimbing2}}">
									<br>		
										</div>
										<div class="col-md-4">
											<label>Pilihan Pembimbing 2</label>
									...
									<br>		
										...
										<div class="col-md-4">
											<label>Nomor SK Pembimbing 2</label>
											<input type="text" class="form-control" name="skpb2" placeholder="Nomor SK pembimbing 2">
										</div>
									</div>
									<a href="/lampiran/{{$data->stambuk}}" class="btn btn-info">Lihat File Lampiran</a>
									<button type="submit" class="btn btn-success">Terima Judul</button>
								</div>
								</form>
							</div>
					</div>
