			...
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						...
						<li>
							<a href="#subPages3" data-toggle="collapse" class="collapsed"><i class="lnr lnr-file-empty"></i> <span>Seminar Skripsi</span> <i class="icon-submenu lnr lnr-chevron-left"></i></a>
							<div id="subPages3" class="collapse ">
								<ul class="nav">
									...
									<li><a href="/terujim" class="">Telah Seminar Hasil</a></li>
						...
						<div class="col-md-12">
							...
							<div class="panel">
								<div class="panel-heading">
									<h3 class="panel-title"><a href="">Jadwal Seminar Proposal</a></h3>
									<div class="right">
									...
									<table class="table table-striped">
										...
										<tbody>
											...
											<tr>
												...
												<td>{{$d->status}}</td>
												<td>{{$d->jadwalp}}</td>
												<td><a href="/ujikanp/{{$d->id}}" class="btn btn-success btn-sm"><i class="fa fa-check"></i></a>
													<a href="/sk_proposal/{{$d->stambuk}}" class="btn btn-info btn-sm"><i class="fa fa-eye" title="SK Ujian"></i></a></td>
